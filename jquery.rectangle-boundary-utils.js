 ...
 */
function rectBoundaryTest() {
  $('#result').append('<div>' + 'is inside => ' + $('.box1').isInside('.box2') + '</div>');
  $('#result').append('<div>' + 'is isColliding => ' + $('.box1').isColliding('.box2') + '</div>');
  $('#result').append('<div>' + 'is isContaining => ' + $('.box1').isContaining('.box2') + '</div>');
  $('#result').append('<div>' + 'is union => ' + JSON.stringify($('.box1').union('.box2'), null, true) + '</div>');
  $('#result').append('<div>' + 'is intersect => ' + JSON.stringify($('.box1').intersect('.box2'), null, true) + '</div>');
}
